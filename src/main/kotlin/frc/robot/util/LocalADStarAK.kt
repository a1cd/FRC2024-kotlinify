...
class LocalADStarAK : Pathfinder {
    private val io: ADStarIO = ADStarIO()
    ...
    private class ADStarIO : LoggableInputs {
        ...
        override fun toLog(table: LogTable) {
            ...
            val pointsLogged: DoubleArray = DoubleArray(currentPathPoints.size * 2)
            var idx: Int = 0
            for (point: PathPoint in currentPathPoints) {
        ...
        override fun fromLog(table: LogTable) {
            ...
            val pointsLogged: DoubleArray = table.get("CurrentPathPoints", DoubleArray(0))
        ...
        fun updateCurrentPathPoints(constraints: PathConstraints?, goalEndState: GoalEndState?) {
            val currentPath: PathPlannerPath? = adStar.getCurrentPath(constraints, goalEndState)
